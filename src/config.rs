...
fn get_optional_string_default(
    section_map: &BTreeMap<String, String>,
    _section: &str,
    key: &str,
    default: &str,
...
fn get_optional_string_attribute(
    section_map: &BTreeMap<String, String>,
    section: &str,
    prefix: &str,
...
fn get_optional_float_attribute(
    section_map: &BTreeMap<String, String>,
    section: &str,
    prefix: &str,
...
fn get_optional_bool_attribute(
    section_map: &BTreeMap<String, String>,
    section: &str,
    prefix: &str,
